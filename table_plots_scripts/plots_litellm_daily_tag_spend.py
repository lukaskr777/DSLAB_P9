...
Writes figures to figs/litellm_daily_tag_spend.
"""
...
def plot_all_litellm_daily_tag_spend(
    ...
    # Normalize date to UTC day boundaries and coerce numerics.
    df = df.copy()
    ...
    # Daily aggregates with explicit custom spec to avoid suffixes.
    ...
    # Derive rates and averages using helpers.
    daily = add_rates(
        daily,
        ratios=(
    ...
    for key, fname, title in [
        ("tag", f"top{top}_tags_spend.png", f"Top {top} tags by total spend"),
